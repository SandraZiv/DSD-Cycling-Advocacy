...
def update_road_quality_statistics(trip_uuid, min_road_quality, max_road_quality, avg_road_quality):
    new_values = {
        "vibration": {
            "minVibration": min_road_quality,
            "maxVibration": max_road_quality,
            "avgVibration": avg_road_quality
        }
    }
